...
'</object>';
			...
			case 'flash':
              console.log('ESTAMOS EN CASE FLASH');
				if (mejs.MediaFeatures.isIE) {
...
'</object>';
                   ...
                   console.log('ESTAMOS EN CASE ontainer.innerHTML ');
					container.innerHTML =
...
'class="mejs-shim"></embed>';
			...
			case 'youtube':
				...
				if (window.postMessage) {
					console.log('mejs.YouTubeApi.enqueueIframe  ');
					mejs.YouTubeApi.enqueueIframe(youtubeSettings);		
				} else if (mejs.PluginDetector.hasPluginVersion('flash', [10,0,0]) ) {
					console.log('mejs.PluginDetector.hasPluginVersion  ');
	...
	createFlash: function(settings) {
		...
		*/
		...
		var specialIEContainer,
			youtubeUrl = settings.scheme + 'www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=' + settings.pluginId  + '&amp;version=3&amp;autoplay=0&amp;controls=0&amp;modestbranding=1&loop=0&fs=0';
			...
			bigPlay =
				...
				.bind('click', function() {	 // Removed 'touchstart' due issues on Samsung Android devices where a tap on bigPlay started and immediately stopped the video
					if (t.options.clickToPlayPause) {
						...
						//miglesia añadido
						var isFullScreen = (mejs.MediaFeatures.hasTrueNativeFullScreen && mejs.MediaFeatures.isFullScreen()) || t.isFullScreen;
	                    console.log(7);
						 console.log(finishScreen);
						if (isFullScreen && finishScreen) {
							t.exitFullScreen();
						} else if (!isFullScreen && finishScreen){
							t.enterFullScreen();
						}
						if (media.paused) {
							media.play();
...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
			...
			} else if (window.fullscreeMode == 'fullwindow') {				
				// move into position
